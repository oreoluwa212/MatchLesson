    ...
    <div className="relative bg-white w-full h-[1117px] overflow-hidden text-left text-base text-neutral-50 font-body-small-m">
      <div className="absolute top-[80px] right-[0px] bg-white w-[1428px] h-[1037px] overflow-hidden text-lg text-primary-main">
        ...
        <div className="absolute top-[322px] left-[0px] w-[1429px] flex flex-row items-start justify-start py-4 pr-[949px] pl-10 box-border gap-[32px]">
          ...
          <div className="rounded-lg bg-mistyrose flex flex-row items-center justify-center py-3 px-[18px] text-indianred border-[1px] border-solid border-indianred">
        ...
        <div className="absolute top-[418px] left-[calc(50%_-_679px)] flex flex-col items-start justify-start gap-[24px] text-indianred">
          <div className="rounded-xl bg-white shadow-[0px_16px_24px_2px_rgba(0,_0,_0,_0.14)] w-[1358px] flex flex-row items-center justify-start py-[30px] pr-[30px] pl-[31px] box-border gap-[32px]">
            <div className="flex flex-col items-end justify-start gap-[8px]">
              <div className="w-[1241px] flex flex-row items-center justify-center gap-[252px]">
                <div className="w-[610px] flex flex-row items-end justify-start gap-[13px]">
                  <div className="relative w-7 h-7">
                    <div className="absolute top-[0px] left-[0px] rounded-[50%] bg-mistyrose box-border w-7 h-7 border-[1px] border-solid border-indianred" />
                    <b className="absolute top-[2px] left-[7px] leading-[24px]">
                      D
                    </b>
                  </div>
                ...
                <div className="flex flex-row items-start justify-start gap-[48px] text-base">
                  <div className="flex flex-row items-start justify-start gap-[8px]">
                    ...
                    />
                    <div className="relative tracking-[0.01em] leading-[24px] inline-block w-[121px] shrink-0">
                      <p className="m-0">Due for Nov.</p>
